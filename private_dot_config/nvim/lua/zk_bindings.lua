...
function M.setup()
  ...
  vim.keymap.set("n", "<leader>zna", '<Cmd>ZkNew { template = "ai.md"}<CR>', opts)
  ...
  vim.keymap.set("n", "<leader>znk", ":NewAnkiNote<CR>", { silent = true })
  ...
  vim.keymap.set("v", "[[pr", ":'<,'>ZkInsertLinkAtSelection { tags = {'project', 'active'}, sort = {'modified'}}<CR>", opts)
  vim.keymap.set("v", "[[a", ":'<,'>ZkInsertLinkAtSelection { tags = {'ai'}, sort = {'modified'}}<CR>", opts)
  ...
  vim.keymap.set("v", "[[k", ":'<,'>ZkInsertLinkAtSelection { tags = {'anki'}, sort = {'modified'}}<CR>", opts)
  ...
  vim.keymap.set("i", "[[pr", '<Cmd>ZkYankName { tags = {"project", "active"}, sort = {"modified"}}<CR>', opts)
  vim.keymap.set("i", "[[a", '<Cmd>ZkYankName { tags = {"ai"}, sort={"modified"}}<CR>', opts)
  ...
  vim.keymap.set("n", "<leader>zopr", '<Cmd>ZkNotes { tags = {"project", "active"}, sort = {"modified"}, exclude = {tags = "archived"}}<CR>', opts)
  vim.keymap.set("n", "<leader>zoa", '<Cmd>ZkNotes { tags = {"ai"}, sort = {"modified"} }<CR>', opts)
  ...
  vim.keymap.set("n", "<leader>zok", '<Cmd>ZkNotes { tags = {"anki"}, sort = {"modified"} }<CR>', opts)
  ...
  vim.keymap.set("n", "<leader>zba", '<Cmd>ZkBacklinks { tags = {"ai"}, sort = {"title"} }<CR>', opts)
  ...
  vim.keymap.set("n", "<leader>zba", '<Cmd>ZkBacklinks { tags = {"anki"}, sort = {"title"} }<CR>', opts)
  ...
  vim.keymap.set("n", "<leader>zla", '<Cmd>ZkLinks { tags = {"ai"}, sort = {"title"} }<CR>', opts)
  ...
  vim.keymap.set("n", "<leader>zlk", '<Cmd>ZkLinks { tags = {"anki"}, sort = {"title"} }<CR>', opts)
